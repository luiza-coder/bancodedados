...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Todos os Livros</h2>
                        <a href="create.php" class="btn btn-success pull-right">Adicionar novo Livro</a>
                    </div>
                    <?php
                    // Include config file
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a href='delete.php?id=". $row['id'] ."' title='Apagar Registro' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
            ...
            <h5>Endereço IPv4 do Servidor: <?php echo $_SERVER['SERVER_ADDR']; ?> </h5>
        </div>
    </div>
</body>
</html>
